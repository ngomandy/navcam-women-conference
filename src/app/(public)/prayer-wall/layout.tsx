...
export const metadata: Metadata = {
  ...
  description: "Join us in prayer as we prepare our hearts for the 2026 Navigators of Cameroon National Women's Conference. Eight themes to pray through together.",
  openGraph: {
    title: "Prayer Wall — 2026 NavCam Women's Conference",
