...
export const metadata: Metadata = {
  ...
  description: "Two rounds of focused breakout sessions at the 2026 Navigators National Women's Conference. Choose your session on Day 2 and Day 3 in Yaoundé, Cameroon.",
  openGraph: {
    title: "Breakout Sessions — 2026 NavCam Women's Conference",
